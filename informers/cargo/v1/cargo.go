...
func NewCargoInformer(client kubernetes.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewFilteredCargoInformer(client, namespace, resyncPeriod, indexers, nil)
}
