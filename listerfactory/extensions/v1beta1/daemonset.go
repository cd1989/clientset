...
var _ v1beta1.DaemonSetLister = &daemonSetLister{}

var _ v1beta1.DaemonSetNamespaceLister = &daemonSetNamespaceLister{}
...
func NewDaemonSetLister(client kubernetes.Interface) v1beta1.DaemonSetLister {
	return NewFilteredDaemonSetLister(client, nil)
}

func NewFilteredDaemonSetLister(client kubernetes.Interface, tweakListOptions internalinterfaces.TweakListOptionsFunc) v1beta1.DaemonSetLister {
...
func (s *daemonSetLister) List(selector labels.Selector) (ret []*extensions_v1beta1.DaemonSet, err error) {
	...
	list, err := s.client.ExtensionsV1beta1().DaemonSets(v1.NamespaceAll).List(listopt)
	if err != nil {
		return nil, err
	}
...
func (s *daemonSetLister) DaemonSets(namespace string) v1beta1.DaemonSetNamespaceLister {
...
func (s daemonSetNamespaceLister) List(selector labels.Selector) (ret []*extensions_v1beta1.DaemonSet, err error) {
	...
	list, err := s.client.ExtensionsV1beta1().DaemonSets(s.namespace).List(listopt)
	if err != nil {
		return nil, err
	}
	for i := range list.Items {
