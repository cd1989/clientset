...
func (s *roleBindingLister) List(selector labels.Selector) (ret []*rbac_v1.RoleBinding, err error) {
	...
	list, err := s.client.RbacV1().RoleBindings(meta_v1.NamespaceAll).List(listopt)
	if err != nil {
		return nil, err
	}
...
func (s roleBindingNamespaceLister) List(selector labels.Selector) (ret []*rbac_v1.RoleBinding, err error) {
	listopt := meta_v1.ListOptions{
		LabelSelector: selector.String(),
	}
	if s.tweakListOptions != nil {
...
func (s roleBindingNamespaceLister) Get(name string) (*rbac_v1.RoleBinding, error) {
	return s.client.RbacV1().RoleBindings(s.namespace).Get(name, meta_v1.GetOptions{})
}
