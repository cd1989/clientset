...
func (s *roleLister) List(selector labels.Selector) (ret []*rbac_v1alpha1.Role, err error) {
...
func (s roleNamespaceLister) List(selector labels.Selector) (ret []*rbac_v1alpha1.Role, err error) {
	listopt := v1.ListOptions{
		LabelSelector: selector.String(),
	}
	if s.tweakListOptions != nil {
...
func (s roleNamespaceLister) Get(name string) (*rbac_v1alpha1.Role, error) {
