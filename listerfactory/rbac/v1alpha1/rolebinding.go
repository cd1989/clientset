...
var _ v1alpha1.RoleBindingLister = &roleBindingLister{}

var _ v1alpha1.RoleBindingNamespaceLister = &roleBindingNamespaceLister{}
...
func NewRoleBindingLister(client kubernetes.Interface) v1alpha1.RoleBindingLister {
	return NewFilteredRoleBindingLister(client, nil)
}

func NewFilteredRoleBindingLister(client kubernetes.Interface, tweakListOptions internalinterfaces.TweakListOptionsFunc) v1alpha1.RoleBindingLister {
...
func (s *roleBindingLister) List(selector labels.Selector) (ret []*rbac_v1alpha1.RoleBinding, err error) {
	...
	list, err := s.client.RbacV1alpha1().RoleBindings(v1.NamespaceAll).List(listopt)
	if err != nil {
		return nil, err
	}
...
func (s *roleBindingLister) RoleBindings(namespace string) v1alpha1.RoleBindingNamespaceLister {
...
func (s roleBindingNamespaceLister) List(selector labels.Selector) (ret []*rbac_v1alpha1.RoleBinding, err error) {
	...
	list, err := s.client.RbacV1alpha1().RoleBindings(s.namespace).List(listopt)
	if err != nil {
		return nil, err
	}
	for i := range list.Items {
