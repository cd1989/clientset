...
func (s *clusterRoleBindingLister) List(selector labels.Selector) (ret []*rbac_v1beta1.ClusterRoleBinding, err error) {
...
func (s *clusterRoleBindingLister) Get(name string) (*rbac_v1beta1.ClusterRoleBinding, error) {
