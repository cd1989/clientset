...
var _ v1alpha1.VolumeAttachmentLister = &volumeAttachmentLister{}
...
func NewVolumeAttachmentLister(client kubernetes.Interface) v1alpha1.VolumeAttachmentLister {
	return NewFilteredVolumeAttachmentLister(client, nil)
}

func NewFilteredVolumeAttachmentLister(client kubernetes.Interface, tweakListOptions internalinterfaces.TweakListOptionsFunc) v1alpha1.VolumeAttachmentLister {
...
func (s *volumeAttachmentLister) List(selector labels.Selector) (ret []*storage_v1alpha1.VolumeAttachment, err error) {
	...
	list, err := s.client.StorageV1alpha1().VolumeAttachments().List(listopt)
	if err != nil {
		return nil, err
	}
